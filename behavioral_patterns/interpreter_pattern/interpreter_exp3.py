#!/usr/bin/env python3
"""
EXAMPLE - https://sourcemaking.com/design_patterns/interpreter
...
class AbstractExpression(metaclass=abc.ABCMeta):
    """
    Declare an abstract Interpret operation that is
...
class NonterminalExpression(AbstractExpression):
    """
    Implement an Interpret operation for nonterminal
...
class TerminalExpression(AbstractExpression):
    """
    Implement an Interpret operation associated
      with terminal symbols in the grammar.
    """

    def interpret(self):
        print("TEST: TerminalExpression")
