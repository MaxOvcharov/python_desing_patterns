...
class DiagramFactory:
    ...
    class Diagram:
        ...
        def __init__(self, width, height):
            ...
            self.diagram = DiagramFactory.\
                _create_rectangle(self.width, self.height, DiagramFactory.BLANK)
    ...
    class Rectangle:
        ...
        def __init__(self, x, y, width, height, fill, stroke):
            self.x = x
            self.y = y
            self.rows = DiagramFactory.\
                _create_rectangle(width, height,
...
font-family="sans-serif" font-size="{fontsize}">{text}</text>"""
    ...
    class Diagram:
        ...
        def __init__(self, width, height):
            ...
            outline = \
                SvgDiagramFactory.Rectangle(0, 0, width, height, "lightgreen", "black")
